...
{
  extern unsigned int
    sf_Attitude_Control_System_of_Flying_Vehicle_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Attitude_Control_System_of_Flying_Vehicle_process_check_sum_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_Attitude_Control_System_of_Flying_Vehicle_autoinheritance_info( int nlhs,
  ...
  if (strcmp(machineName, "Attitude_Control_System_of_Flying_Vehicle") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Attitude_Control_System_of_Flying_Vehicle_autoinheritance_info
      (nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Attitude_Control_System_of_Flying_Vehicle_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Attitude_Control_System_of_Flying_Vehicle") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Attitude_Control_System_of_Flying_Vehicle_third_party_uses_info
      (nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Attitude_Control_System_of_Flying_Vehicle_jit_fallback_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Attitude_Control_System_of_Flying_Vehicle") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Attitude_Control_System_of_Flying_Vehicle_jit_fallback_info(nlhs,
      plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "Attitude_Control_System_of_Flying_Vehicle") == 0) {
    ...
    newRhs[2] = prhs[3];
    return
      sf_Attitude_Control_System_of_Flying_Vehicle_updateBuildInfo_args_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int
  sf_Attitude_Control_System_of_Flying_Vehicle_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Attitude_Control_System_of_Flying_Vehicle")) {
    return(sf_Attitude_Control_System_of_Flying_Vehicle_method_dispatcher
...
extern void Attitude_Control_System_of_Flying_Vehicle_terminator(void);
void sf_machine_global_terminator(SimStruct* S)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    Attitude_Control_System_of_Flying_Vehicle_terminator();
...
extern void Attitude_Control_System_of_Flying_Vehicle_initializer(void);
extern void Attitude_Control_System_of_Flying_Vehicle_register_exported_symbols
  (SimStruct* S);
extern void Attitude_Control_System_of_Flying_Vehicle_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Attitude_Control_System_of_Flying_Vehicle_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Attitude_Control_System_of_Flying_Vehicle_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    Attitude_Control_System_of_Flying_Vehicle_initializer();
  }
